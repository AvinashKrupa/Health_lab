...
import UpcomingAppointments from "../src/lab/view/appointment/UpcomingAppointments";
      ...
      <div className="App">
        <BrowserRouter>
          <Switch>
            ...
            <MainView>
              <Switch>
                <PrivateRoute exact path='/appointments' component={UpcomingAppointments}/>
                <PrivateRoute exact path='/appointment/search' component={UpcomingAppointments}/>
